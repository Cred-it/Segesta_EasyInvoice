pageextension 70571577 "CREDIT EasyInv Posted Invoice" extends "Posted Purchase Invoice"
{
    ...
    begin
        IF NOT EasyInvoiceCon.GET(EasyInvoiceCon.Type::"Posted Purchase Invoice", Rec."No.") then
            EasyInvoiceCon.INIT;
    end;
