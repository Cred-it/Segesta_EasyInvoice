codeunit 66000 "Easy Invoice Webservice"
{
          ...
          PurchHeader."Document Type"::Invoice :
            BEGIN
              ...
              IF PurchInvHeader.GET(PurchInvHeaderNo) THEN BEGIN
                ...
                IF nEasyInvConnect.Insert() THEN;
          ...
          PurchHeader."Document Type"::"Credit Memo"  :
            BEGIN
              IF PurchCrMemoHeader.GET(PurchCrMemoHeaderNo) THEN BEGIN
                ...
                IF VendorLedgerEntry.GET(PurchCrMemoHeader."Vendor Ledger Entry No.") THEN
                  BEGIN
                    nEasyInvConnect.Type := nEasyInvConnect.Type::"Vendor Ledger Entry";
                    nEasyInvConnect."Document No." := FORMAT(VendorLedgerEntry."Entry No.");
                    IF nEasyInvConnect.Insert() THEN;
    ...
    begin
        ...
        IF gTmpPurchLine.FINDSET THEN REPEAT
          CLEAR(partdel);
          ...
          WITH PurchLine DO BEGIN
            ...
            IF gTmpPurchLine.Type <> gTmpPurchLine.Type::"Charge (Item)" THEN BEGIN  //******* CHARGE 21-01-2014 *****
              ...
              //Ontvangst
              IF gTmpPurchLine."Document Type" = gTmpPurchLine."Document Type"::Invoice THEN
              BEGIN
    ...
    begin
        ...
        IF gTmpDimension.FINDSET THEN REPEAT
          ...
          WITH DimSetEntryTmp DO BEGIN
            ...
            CASE TRUE OF
              GeneralLedgerSetup."Global Dimension 1 Code" = "Dimension Code" : locDimension1:="Dimension Value Code";
              GeneralLedgerSetup."Global Dimension 2 Code" = "Dimension Code" : locDimension2:="Dimension Value Code";
            END;
    ...
    begin
        ...
        IF LocPurchLine.FINDSET THEN REPEAT
          ...
          IF (LocPurchLine.Type = LocPurchLine.Type::Item) AND (LocPurchLine."Direct Unit Cost" = 0) AND
            LocRecItem.GET(LocPurchLine."No.") THEN
          BEGIN
